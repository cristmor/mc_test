...
#include <iostream>
{
   ...
   TFile *f2 = new TFile("histEXP4_45deg_16ftnewgeonoledgeleg2_3MILL.root","READ");
...
/*
  ...
  */
   ...
   int nx=xy11away->GetNbinsY();
   int ny=xy11away->GetNbinsX();
   cout<<"nx="<<nx<<"   ny="<<ny<<endl;

//   TH2D* plotA=new TH2D("plotA","MC (11ft)",13,-15.0,12.0,13,-15.0,12.0);
   TH2D* plotA=new TH2D("plotA","MC (Water 16ft)",15,-15.0,15.0,15,-15.0,15.0);

   ofstream out ("wt16ft.txt");
   for (int ix=1; ix<nx; ix++) {
      for(int iy=1; iy<ny; iy++) {
         double wtA=xy11away->GetBinContent(ix,iy);//collecting bin contents for everybin in 2D projection plot of away
         //double wtT=xy11tank->GetBinContent(nx-ix+2,iy);
         double wtT=xy11tank->GetBinContent(ix,iy);//collection bin contents for everybin in 2D projection plot of watertank
